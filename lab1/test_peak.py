...
class TestPeak(unittest.TestCase):
    ...
    def test_array_is_sorted_increasinly(self):
        self.assertEqual(peak.find_the_longest_peak([1, 2, 3, 4, 5, 6, 7, 8]), [])
    
    def test_array_is_sorted_decreasinly(self):
        self.assertEqual(peak.find_the_longest_peak([8, 7, 6, 5, 4, 3, 2, 1]), [])

    def test_array_of_two_el(self):
        self.assertEqual(peak.find_the_longest_peak([3,5]), [])
