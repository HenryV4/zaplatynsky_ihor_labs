    ...
    while new_matrix:
        ...
        for delta_row, delta_column in directions:
            ...
            if (0 <= neighbor_row < num_rows and 
                0 <= neighbor_column < num_colomns and 
                matrix[neighbor_row][neighbor_column] == old_color):
...
def main():
    input_file = 'c:/WORK/PROG/2/lab/src/input.txt'
    output_file = 'c:/WORK/PROG/2/lab/src/output.txt'
    num_rows, num_columns, start_row, start_column, new_color, matrix = read_input(input_file)

    print("Matrix dimensions:", num_rows, "x", num_columns)
