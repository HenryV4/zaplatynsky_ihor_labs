import unittest
import sys
sys.path.append('C:/WORK/PROG/2/lab/src')
...
class TestAggressiveCows(unittest.TestCase):
    ...
    def test_2(self):
        cities = ["Lviv", "Kyiv", "Rivne", "Dnipro", "Odesa"]
        storages = ["Storage_1", "Storage_2"]
        pipelines = [["Storage_1", "Storage_2"], ["Lviv", "Rivne"], ["Lviv", "Kyiv"], ["Lviv", "Odesa"]]
        self.assertEqual(check_gas_delivery(cities, storages, pipelines), ["Lviv", "Kyiv", "Rivne", "Dnipro", "Odesa"])
