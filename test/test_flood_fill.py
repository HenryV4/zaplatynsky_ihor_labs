...
class TestFloodFill(unittest.TestCase):
    def test_flood_fill_same_color(self):
        ...
        expected_matrix = [['G', 'G', 'G', 'G', 'G'],
                           ...
                           ['G', 'G', 'G', 'G', 'G'],
                           ['G', 'G', 'G', 'G', 'G']]
        self.assertEqual(flood_fill(num_rows, num_columns, matrix, start_row, start_column, new_color), expected_matrix)
    ...
    def test_with_files(self):
        ...
        num_rows, num_columns, start_row, start_column, new_color, matrix = read_input(input_file)
        ...
        self.assertEqual(flood_fill(num_rows, num_columns, matrix, start_row, start_column, new_color), matrix)
